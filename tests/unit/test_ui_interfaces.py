...
class TestUserInterface:
    ...
    def test_display_batch_decisions_keyboard_mode(self, mock_curses, mock_isatty, mock_bookmarks, mock_claude_decisions):
    ...
    @patch('raindrop_cleanup.ui.interfaces.os.isatty')
    def test_display_batch_decisions_no_tty_fallback(self, mock_isatty, mock_bookmarks, mock_claude_decisions):
        """Test fallback to text mode when not in TTY."""
        mock_isatty.return_value = False
        
        with patch.object(UserInterface, '_display_text_interface', return_value=[1]) as mock_text:
            ui = UserInterface(text_mode=False)
            selected = ui.display_batch_decisions(mock_bookmarks, mock_claude_decisions)
            
            assert selected == [1]
            mock_text.assert_called_once_with(mock_bookmarks, mock_claude_decisions)
    
    @patch('raindrop_cleanup.ui.interfaces.curses', side_effect=ImportError("No curses"))
    def test_display_batch_decisions_no_curses_fallback(self, mock_curses, mock_bookmarks, mock_claude_decisions):
        """Test fallback to text mode when curses is unavailable."""
        with patch.object(UserInterface, '_display_text_interface', return_value=[2]) as mock_text:
            ui = UserInterface(text_mode=False)
            selected = ui.display_batch_decisions(mock_bookmarks, mock_claude_decisions)
    ...
    def test_display_batch_decisions_force_text_mode(self, mock_bookmarks, mock_claude_decisions):
        """Test forcing text mode regardless of terminal capabilities."""
        with patch.object(UserInterface, '_display_text_interface', return_value=[0, 1]) as mock_text:
            ui = UserInterface(text_mode=True)
            selected = ui.display_batch_decisions(mock_bookmarks, mock_claude_decisions)
    ...
    def test_display_text_interface_all_actions(self, mock_print, mock_input, mock_bookmarks, mock_claude_decisions):
    ...
    @patch('builtins.input')
    @patch('builtins.print')
    def test_display_text_interface_deletes_only(self, mock_print, mock_input, mock_bookmarks, mock_claude_decisions):
    ...
    @patch('builtins.input')
    @patch('builtins.print')
    def test_display_text_interface_moves_only(self, mock_print, mock_input, mock_bookmarks, mock_claude_decisions):
    ...
    @patch('builtins.input')
    @patch('builtins.print')
    def test_display_text_interface_archives_only(self, mock_print, mock_input, mock_bookmarks):
    ...
    @patch('builtins.input')
    @patch('builtins.print')
    def test_display_text_interface_none_selection(self, mock_print, mock_input, mock_bookmarks, mock_claude_decisions):
    ...
    @patch('builtins.input')
    @patch('builtins.print')
    def test_display_text_interface_empty_selection(self, mock_print, mock_input, mock_bookmarks, mock_claude_decisions):
    ...
    @patch('builtins.input')
    @patch('builtins.print')
    def test_display_text_interface_quit(self, mock_print, mock_input, mock_bookmarks, mock_claude_decisions):
    ...
    @patch('builtins.input')
    @patch('builtins.print')
    def test_display_text_interface_invalid_then_valid(self, mock_print, mock_input, mock_bookmarks, mock_claude_decisions):
    ...
    @patch('builtins.print')
    def test_display_text_interface_shows_recommendations(self, mock_print, mock_bookmarks, mock_claude_decisions):
    ...
    def test_display_text_interface_shows_move_target(self, mock_print, mock_bookmarks):
        ...
        decisions = [
            {'action': 'MOVE', 'target': 'Development', 'reasoning': 'programming content'},
            {'action': 'DELETE', 'reasoning': 'outdated'},
        ]
