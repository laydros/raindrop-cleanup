...
class TestRaindropBookmarkCleaner:
    ...
    def test_init_components(
        self, mock_state_manager, mock_ui, mock_claude, mock_raindrop
    ):
        """Test that all components are initialized properly."""
        cleaner = RaindropBookmarkCleaner(
            dry_run=True, state_dir="test_dir", text_mode=True
        )
    ...
    @patch("raindrop_cleanup.core.processor.UserInterface")
    @patch("raindrop_cleanup.core.processor.StateManager")
    def test_execute_user_selections_skip_all(
        self,
        mock_state_manager,
        mock_ui,
        mock_claude,
    ...
    @patch("raindrop_cleanup.core.processor.UserInterface")
    @patch("raindrop_cleanup.core.processor.StateManager")
    def test_execute_user_selections_delete_action(
        self,
        mock_state_manager,
        mock_ui,
        mock_claude,
    ...
    @patch("raindrop_cleanup.core.processor.UserInterface")
    @patch("raindrop_cleanup.core.processor.StateManager")
    def test_execute_user_selections_move_action(
        self,
        mock_state_manager,
        mock_ui,
        mock_claude,
        ...
        mock_raindrop_instance.find_collection_by_name.return_value = (
            2  # Development collection ID
        )
        ...
        mock_raindrop_instance.find_collection_by_name.assert_called_once_with(
            mock_collections, "Development"
        )
        mock_raindrop_instance.move_bookmark_to_collection.assert_called_once_with(
            101, 2
        )
    ...
    @patch("raindrop_cleanup.core.processor.UserInterface")
    @patch("raindrop_cleanup.core.processor.StateManager")
    def test_execute_user_selections_archive_action(
        self, mock_state_manager, mock_ui, mock_claude, mock_raindrop, mock_bookmarks
    ):
    ...
    @patch("raindrop_cleanup.core.processor.UserInterface")
    @patch("raindrop_cleanup.core.processor.StateManager")
    def test_execute_user_selections_dry_run(
        self,
        mock_state_manager,
        mock_ui,
        mock_claude,
    ...
    @patch("raindrop_cleanup.core.processor.UserInterface")
    @patch("raindrop_cleanup.core.processor.StateManager")
    def test_execute_user_selections_api_failures(
        self,
        mock_state_manager,
        mock_ui,
        mock_claude,
    ...
    def test_process_collection_fresh_start(
        self,
        mock_input,
        mock_state_manager,
        mock_ui,
        ...
        mock_ui_instance.display_batch_decisions.return_value = [
            0
    ...
    @patch("raindrop_cleanup.core.processor.UserInterface")
    @patch("raindrop_cleanup.core.processor.StateManager")
    def test_process_collection_keyboard_interrupt(
        self, mock_state_manager, mock_ui, mock_claude, mock_raindrop
    ):
    ...
    @patch("raindrop_cleanup.core.processor.UserInterface")
    @patch("raindrop_cleanup.core.processor.StateManager")
    def test_process_collection_completed(
        self, mock_state_manager, mock_ui, mock_claude, mock_raindrop
    ):
        ...
        mock_raindrop_instance = Mock()
        mock_raindrop_instance.get_bookmarks_from_collection.return_value = {
            "items": []
        }  # Empty collection
        mock_raindrop.return_value = mock_raindrop_instance
    ...
    @patch("raindrop_cleanup.core.processor.UserInterface")
    @patch("raindrop_cleanup.core.processor.StateManager")
    def test_print_stats_delegates_to_state_manager(
        self, mock_state_manager, mock_ui, mock_claude, mock_raindrop
    ):
    ...
    @patch("raindrop_cleanup.core.processor.StateManager")
    @patch("builtins.input")
    def test_process_collection_break_suggestion(
        self, mock_input, mock_state_manager, mock_ui, mock_claude, mock_raindrop
    ):
        ...
        mock_state_instance.load_state.return_value = None
        mock_state_instance.processed_bookmark_ids = set()
        mock_state_instance.is_bookmark_processed.return_value = (
            False  # No bookmarks pre-processed
        )
        ...
        mock_claude_instance.analyze_batch.side_effect = [
            [
                {"action": "KEEP", "reasoning": "test"} for _ in range(25)
            ],  # First batch of 25
